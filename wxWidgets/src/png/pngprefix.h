...
#define png_handle_chunk wx_png_handle_chunk
...
#define png_set_rgb_coefficients wx_png_set_rgb_coefficients
...
#define png_resolve_file_gamma wx_png_resolve_file_gamma
