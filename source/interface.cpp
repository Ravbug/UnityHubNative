...
PlusProActivationDlgBase::PlusProActivationDlgBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText9 = new wxStaticText( this, wxID_ANY, wxT("Email"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText9->Wrap( -1 );
...
ConfigureEditorDlgBase::ConfigureEditorDlgBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	moduleSelectTree = new wxTreeListCtrl( this, ID_MODULESELECTTREE, wxDefaultPosition, wxDefaultSize, wxTL_CHECKBOX|wxTL_DEFAULT_STYLE );
